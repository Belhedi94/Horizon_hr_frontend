...
const JobOffersDataList = ({props}) => {
    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                Cell: ({ row }) => (
                    <div>
                        <Link to={`/jobs/offers/edit/${row.original.id}`}>
                            <FontAwesomeIcon
                                data-tooltip-id={"edit_offer_tooltip"}
                                icon={faPenClip}
                                size={"xl"}
                        ...
                        <span
                            data-tooltip-id={"delete_offer_tooltip"}
    ...
    return (
        <div>
            ...
            <Tooltip
                id="delete_offer_tooltip"
                place="top"
                content="Delete job offer"
                variant={"dark"}
            />
            <Tooltip
                id="edit_offer_tooltip"
                place="top"
...
export default JobOffersDataList;